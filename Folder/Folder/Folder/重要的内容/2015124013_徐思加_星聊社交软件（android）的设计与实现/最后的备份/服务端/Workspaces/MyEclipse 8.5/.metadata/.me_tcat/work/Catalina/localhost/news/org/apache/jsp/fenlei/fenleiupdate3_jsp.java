...
public final class fenleiupdate3_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\tif(document.getElementById(\"fnameid\").value==\"\"){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\talert('新闻分类名不能为空');\r\n");
      ...
      out.write("            <p>\r\n");
      out.write("              <label>新闻分类名</label>\r\n");
      out.write("              <input class=\"text-input small-input\" type=\"text\" id=\"fnameid\" name=\"fname\"  value=\"");
